...
This script works in conjunction with the FreePBX Trunk Balancing Module version 1.1.2 and higher,
the module must be installed and enabled with defined balanced trunks. Running this script on the 
FreePBX host, will allow a user to enable or disable a defined balanced trunk.
